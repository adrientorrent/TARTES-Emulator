...
"""
Full script to train a model.

It would be helpful to create a JSON parser for selecting hyperparameters.
"""
...
def main():
    ...
    model_path = f"{data_dir}/model_test.pt"
    checkpoint = {}
    if RESUME_TRAINING:
    ...
    csv_file_path = f"{data_dir}/results_test.csv"
