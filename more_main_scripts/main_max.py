...
from models import CnnTartesEmulatorMax
from training import train_loop, evaluate_loop
from utils.norm import CustomNorm


"""Same as main.py, with the model : CnnTartesEmulatorMax"""
...
def main():
    ...
    model_path = f"{data_dir}/model_max.pt"
    checkpoint = {}
    if RESUME_TRAINING:
    ...
    csv_file_path = f"{data_dir}/results_max.csv"
