...
"""Same as main.py, with LR scheduler: ReduceLROnPlateau"""
...
def main():
    ...
    model_path = f"{data_dir}/model_reduceLRonPlateau.pt"
    checkpoint = {}
    if RESUME_TRAINING:
    ...
    print("LRScheduler: ReduceLROnPlateau")
    if RESUME_TRAINING:
    ...
    csv_file_path = f"{data_dir}/results_reduceLRonPlateau.csv"
